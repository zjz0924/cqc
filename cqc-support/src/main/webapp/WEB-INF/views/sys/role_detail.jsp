        ...
        $(function(){
            ...
            if(resultCode != null && resultCode != '' && resultCode != undefined){
                ...
                if(resultCode == "01" || resultCode == "03"){ 
                    window.location.href = "${ctx}/roleController/list";
                }else{
                    // 设置按钮可点
    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-user"></i><a href="${ctx}/roleController/list">^管理</a></li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="padding-top:30px;padding-left:30px;">
                    <form action="${ctx}/roleController/save" method="post" onsubmit="return checkData();">
