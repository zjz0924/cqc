...
public class APIRequestAuthFilter implements Filter
{
   enum StatusCode {
      ...
      OK(200, "OK"), UNAUTHORIZED(401, ""), FORBIDDEN(403, "Forbidden"), NOT_FOUND(404, "Not found"), INTERNAL_ERROR(500, "Internal Error");
   ...
   public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
   {
      ...
      try
      {
         ...
         {
            LOGGER.debug("authorizeUserLogin status: " + statusCode + ", Request URI: " + httpRequest.getRequestURI() + ", method: "
      ...
      {
         httpResponse.addHeader("WWW-Authenticate", "Basic realm=\"MSA API\"");
      }
      LOGGER.debug("Response status: " + responseStatus + ", Request URI: " + httpRequest.getRequestURI() + ", method: " + httpRequest.getMethod());
   ...
   private StatusCode authorizeUserLogin(HttpServletRequest request) throws Exception
   {
      ...
      // IMPORTANT: and we have a back door for UISDK dev which we always have a cross domain access between UISDK server and MSA Tomcat
      ...
      if (decodeString != null)
      {
         ...
         User user = username == "admin" ? new User() : null; // 从数据库读取用户
         if (user != null)
         {
            String passwordMD5 = ""; // md5加密码
